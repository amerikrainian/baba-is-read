...
# releases\BabaAccessInstaller.exe. Needs cargo and libclang (the wxWidgets
...
$targetExe = Join-Path $installerDir "target\release\baba-access-installer.exe"
$outputExe = Join-Path $releaseDir "BabaAccessInstaller.exe"
