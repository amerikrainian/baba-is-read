...
# releases\BabaIsReadInstaller.exe. Needs cargo and libclang (the wxWidgets
...
$targetExe = Join-Path $installerDir "target\release\baba-is-read-installer.exe"
$outputExe = Join-Path $releaseDir "BabaIsReadInstaller.exe"
